          ...
          <div className="max-w-5xl mx-auto">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-300 bg-white text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-colors"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-300 bg-white text-slate-900 focus:ring-2 focus:ring-brand-500 focus:border-transparent appearance-none transition-colors"
                  >
            ...
            <div className="mt-4 flex items-center justify-between">
              <div className="text-sm text-slate-600">
                {t('reflections.showing')} <span className="font-semibold text-slate-900">{filteredReflections.length}</span> {t('reflections.of')} <span className="font-semibold text-slate-900">{reflections.length}</span> {t('reflections.reflections')}
              </div>
          ...
          <div className="container-xl">
            <div className="max-w-5xl mx-auto">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-2xl font-bold text-slate-900">{t('reflections.featured')}</h2>
              </div>
              
              <Link
                to={`/reflections/${featuredReflection.id}`}
                className="group block bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden border border-slate-200"
              >
                <div className="p-8 md:p-10">
                  <div className="flex flex-wrap items-center gap-3 mb-6">
                    <span className="inline-flex items-center gap-2 bg-brand-100 text-brand-700 rounded-full px-4 py-1.5 text-sm font-semibold">
        ...
        <div className="container-xl">
          {loading ? (
            ...
            <div className="text-center py-16 max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">{t('reflections.no_results')}</h3>
            ...
            <div className="text-center py-16 max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">{t('reflections.no_reflections')}</h3>
              <p className="text-slate-600">{t('reflections.no_reflections_desc')}</p>
            </div>
          ) : otherReflections.length > 0 ? (
            <>
              <h2 className="text-2xl font-bold text-slate-900 mb-8">{t('reflections.all_reflections')}</h2>
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">

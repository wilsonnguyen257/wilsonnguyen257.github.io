          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-2">
                {language === 'vi' ? 'Nội dung (VI) - Tự động làm sạch khi dán' : 'Content (Vietnamese) - Auto-clean on paste'}
              </label>
              <div onPaste={(e) => handleContentPaste(e, 'contentVi')}>
                <VisualEditor
                  value={formData.contentVi}
                  onChange={(value) => setFormData({ ...formData, contentVi: value })}
                  placeholder={language === 'vi' ? 'Nhập hoặc dán nội dung...' : 'Enter or paste content...'}
                />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium mb-2">
                {language === 'vi' ? 'Nội dung (EN) - Tự động làm sạch khi dán' : 'Content (English) - Auto-clean on paste'}
              </label>
              <div onPaste={(e) => handleContentPaste(e, 'contentEn')}>
                <VisualEditor

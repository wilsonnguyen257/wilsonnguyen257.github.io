      ...
      <section className={`relative bg-gradient-to-br from-brand-600 via-brand-700 to-brand-800 text-white ${UI_CONSTANTS.SECTION_PADDING} overflow-hidden`}>
        ...
        <div className="container-xl relative z-10">
          <div className="max-w-3xl animate-fadeIn">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-5 py-2.5 mb-6 shadow-sm hover:bg-white/20 transition-colors">
              <svg className="w-5 h-5 text-brand-100" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
              </svg>
              <span className="font-bold text-brand-50">{t('contact.get_in_touch')}</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight font-serif tracking-tight">{t('contact.title')}</h1>

      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        {images.length === 0 ? (
          ...
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {images.map((img) => (
              <div key={img.id} className="relative group bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden border border-slate-200 dark:border-slate-700 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  {editingId === img.id ? (
                    <div className="space-y-3">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg text-sm dark:bg-slate-700 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent [color-scheme:light] dark:[color-scheme:dark]"
                      />
                    ...
                    <>
                      <div className="text-sm text-slate-900 dark:text-white font-semibold truncate mb-1">
                        {img.name}
                      </div>

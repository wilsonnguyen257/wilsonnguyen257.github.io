      ...
      <section className="container-xl py-24">
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl p-10 border-2 border-slate-100 dark:border-slate-700">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">{t('contact.send_message')}</h2>
              
              {submitStatus === 'success' && (
                <div className="mb-8 p-5 bg-green-50 dark:bg-green-900/20 border-2 border-green-200 dark:border-green-800 rounded-2xl animate-fadeIn">

        ...
        <div className="container-xl">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3 font-serif">{t('gallery.no_results')}</h3>
            ...
            <div className="space-y-14">
              {groups.map((group) => (
                <div key={group.key}>
                  <h2 className="text-2xl font-bold text-slate-900 mb-8 font-serif border-l-4 border-brand-500 pl-4 capitalize">
                    {group.label}
                  </h2>
                  <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {group.items.map((img) => (

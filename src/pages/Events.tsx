              ...
              <div className="p-6 md:p-8">
                ...
                <div className="grid md:grid-cols-[2fr,3fr] gap-6">
                  ...
                  <div className="flex flex-col justify-center">
                    <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4 group-hover:text-brand-600 transition-colors">
                    ...
                    <div className="space-y-3 mb-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm text-slate-500 font-medium">{t('events.date')}</p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm text-slate-500 font-medium">{t('events.time')}</p>
                          <p className="font-semibold text-slate-900">{upcomingEvents[0].time}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className="text-sm text-slate-500 font-medium">{t('events.location')}</p>
                          <p className="font-semibold text-slate-900">{upcomingEvents[0].location}</p>
                        </div>
                      </div>
                    </div>
              ...
              Object.entries(groupedEvents).map(([monthYear, monthEvents]) => (
                <div key={monthYear}>
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900">{monthYear}</h3>
                    ...
                    {monthEvents.map((event) => (
                      ...
                      >
                        <div className="grid md:grid-cols-[200px,1fr] gap-0">
                          {/* Thumbnail */}
                          {event.thumbnail ? (
                            <div className="relative aspect-video md:aspect-square overflow-hidden bg-slate-100">
                              <img 
                                src={event.thumbnail} 
                            ...
                            <div className="hidden md:block bg-gradient-to-br from-brand-100 to-brand-200"></div>
                          )}
                          ...
                          <div className="p-5 md:p-6 flex flex-col justify-between">
                            <div>
                              ...
                              {!event.thumbnail && (
                                <div className="mb-3">
                                  {!hasEventPassed(event.date, event.time || '11:59 PM') ? (
                                    <span className="inline-block bg-green-100 text-green-700 rounded-lg px-3 py-1 text-xs font-bold">
                                      {t('events.upcoming')}
                                    </span>
                                  ) : (
                                    <span className="inline-block bg-slate-100 text-slate-600 rounded-lg px-3 py-1 text-xs font-bold">
                                      {t('events.past')}
                                    </span>
                                  )}
                                </div>
                              ...
                              {/* Title */}
                              <h4 className="text-lg md:text-xl font-bold text-slate-900 mb-3 group-hover:text-brand-600 transition-colors line-clamp-2">
                            ...
                            <div className="mt-4 pt-4 border-t border-slate-100 flex items-center justify-between">
                              <span className="text-sm font-semibold text-brand-600 group-hover:gap-2 flex items-center transition-all">

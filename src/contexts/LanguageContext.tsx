...
const translations = {
  ...
  'gallery.search': 'Tìm kiếm',
  'gallery.search_placeholder': 'Tìm theo tên ảnh...',
  'gallery.sort': 'Sắp xếp',
  'gallery.newest': 'Mới nhất',
  'gallery.oldest': 'Cũ nhất',
  'gallery.showing': 'Hiển thị',
  'gallery.of': '/',
  'gallery.photos': 'ảnh',
  'gallery.no_results': 'Không tìm thấy ảnh nào',
  'gallery.no_results_desc': 'Thử thay đổi từ khóa tìm kiếm.',
  'gallery.clear_filters': 'Xóa bộ lọc',
    ...
    'events.past_events': 'Sự kiện đã diễn ra',
  ...
  'gallery.search_placeholder': 'Search by photo name...',
  'gallery.sort': 'Sort',
  ...
  'gallery.no_results': 'No photos found',
  'gallery.no_results_desc': 'Try changing your search keywords.',
